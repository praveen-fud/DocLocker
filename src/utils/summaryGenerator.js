...
export function generateAndUploadSummaryPDF(
  ...
  _pdfDebounceTimer = setTimeout(() => {
    ...
    _doGeneratePdf(studentName, studentData, studentIdentifier);
  }, 3000);
}

function _doGeneratePdf(studentName, studentData, studentIdentifier) {
  try {
    ...
    const studentSection = section(
      ...
      [
        ...
        row("Loan Amount", p.loanAmount ? "₹" + p.loanAmount : ""),
    ...
    const academicSection = section(
      ...
      "#065f46",
      [
        row("Qualification & Year", p.qualPassedYear),
        row("10th %", p.pct10),
        row("12th %", p.pct12),
        row("Graduation % / CGPA", p.pctGrad),
        row(
          "Backlogs",
          p.hasBacklogs === "Yes"
    ...
    const refSection = section(
      ...
      [
        ...
        row("Ref 1 — Relation", p.ref1_relation === "Other" ? p.ref1_custom_relation : p.ref1_relation),
        ...
        row("Ref 2 — Relation", p.ref2_relation === "Other" ? p.ref2_custom_relation : p.ref2_relation),
...
<div class="cover">
  <div class="cover-logo">FlyurDream · Confidential</div>
...
<div class="body-wrap">
  ...
  ${coSections}
  <div class="footer">
    This document is auto-generated by FlyurDream and intended for authorised bank personnel only.<br>
