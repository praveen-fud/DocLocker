export const DOCUMENT_SCHEMA = {
  applicant: {
    ...
    fields: [
      ...
      { id: 'graduation', label: 'Graduation Marksheets (Semester-wise) & Degree', rename: 'Graduation_Marksheet_Degree', accept: '.pdf,.zip' },
      { id: 'admission_letter', label: 'University/College Admission Letter (if any)', rename: 'Admission_Letter', accept: '.pdf,.jpg,.jpeg,.png', optional: true },
...
export const CO_APPLICANT_SCHEMA = {
  salaried: [
    ...
    { id: 'bank_stmt_6m', label: 'Last 6 Month Bank Statement (salary credited)', rename: 'Bank_Statement_6Months', accept: '.pdf' },
    { id: 'form16_itr', label: 'Form 16 / ITR Acknowledgement (last 2 years)', rename: 'Form16_ITR_2Years', accept: '.pdf,.zip' },
  ],
  selfEmployed: [
    { id: 'aadhar', label: 'Aadhar Card', rename: 'Aadhar', accept: '.pdf,.jpg,.jpeg,.png' },
    { id: 'pan', label: 'PAN Card', rename: 'PAN', accept: '.pdf,.jpg,.jpeg,.png' },
